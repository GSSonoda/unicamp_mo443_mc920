...
def process(input_paths: dict[str, Path], output_dir: Path) -> list[Path]:
    ...
    outputs = {
        "otsu_original.png": image,
        "otsu_binaria.png": threshold_otsu(image),
    }
...
def report_files() -> dict[str, Path]:
    ...
    return {
        "otsu_original.png": output_dir / "otsu_original.png",
        "otsu_binaria.png": output_dir / "otsu_binaria.png",
    }
