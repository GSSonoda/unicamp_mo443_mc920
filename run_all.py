...
from src.exercicio_12.main import run as run_exercicio_12
from src.exercicio_13.main import run as run_exercicio_13
...
def main() -> int:
    ...
    try:
        ...
        run_exercicio_12(overwrite=args.overwrite)
        run_exercicio_13(overwrite=args.overwrite)
