...
\campo{Registro das saídas}{As saídas seguem uma convenção simples de organização por exercício. Os resultados são salvos em \arquivo{results/exercicio\_XX/}, com nomes compatíveis com a transformação aplicada, e as figuras selecionadas para o relatório são copiadas para \arquivo{docs/relatorio/figuras/exercicio\_XX/}. Dessa forma, os diretórios de trabalho permanecem locais, enquanto apenas o material visual necessário para o relatório fica versionado.}
